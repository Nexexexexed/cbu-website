        ...
        >
          ...
          >
            <Motion.div variants={fadeInUp} initial="initial" animate="animate">
              ...
              >
                <BarChartOutlined style={{ fontSize: "clamp(32px, 8vw, 48px)", color: "white" }} />
              </div>
                ...
                <Row gutter={[32, 32]} style={{ marginTop: "40px" }}>
                  <Col xs={24} md={8}>
                    <div style={{ textAlign: "center" }}>
                      <div style={{ fontSize: "clamp(32px, 8vw, 40px)", fontWeight: "bold", color: serviceColor }}>30%</div>
                      <Paragraph style={{ fontWeight: 500, fontSize: "clamp(14px, 3.5vw, 16px)" }}>Снижение затрат в среднем</Paragraph>
                    </div>
                  </Col>
                  
                  <Col xs={24} md={8}>
                    <div style={{ textAlign: "center" }}>
                      <div style={{ fontSize: "clamp(32px, 8vw, 40px)", fontWeight: "bold", color: serviceColor }}>25%</div>
                      <Paragraph style={{ fontWeight: 500, fontSize: "clamp(14px, 3.5vw, 16px)" }}>Рост прибыли клиентов</Paragraph>
                    </div>
                  </Col>
                  
                  <Col xs={24} md={8}>
                    <div style={{ textAlign: "center" }}>
                      <div style={{ fontSize: "clamp(32px, 8vw, 40px)", fontWeight: "bold", color: serviceColor }}>100%</div>
                      <Paragraph style={{ fontWeight: 500, fontSize: "clamp(14px, 3.5vw, 16px)" }}>Контроль финансов</Paragraph>
                    </div>
                  </Col>
                </Row>
              </div>
